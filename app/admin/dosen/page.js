                ...
                <tr key={dosen.id}>
                  ...
                  <td>
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                      ...
                      {dosen.no_wa && (
                        <a href={`https://wa.me/${String(dosen.no_wa).replace(/\D/g, '').startsWith('0') ? '62' + String(dosen.no_wa).replace(/\D/g, '').substring(1) : String(dosen.no_wa).replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" style={{ color: "#25D366", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.85rem", fontWeight: 600 }}>
