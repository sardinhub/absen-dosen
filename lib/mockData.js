...
export const defaultMateri = [];

export const defaultCasis = [
  {
    id: "casis_1",
    niss: "NISS-2026-001",
  ...
  },
  {
    ...
    asal_sekolah: "SMK Penerbangan Makassar",
    jurusan: "AVSEC",
    username: "anisacasis",
    password: "123",
    status_pembayaran: "LUNAS",
  ...
  },
  {
    ...
    asal_sekolah: "SMA Negeri 3 Makassar",
    jurusan: "Flight Attendant",
    username: "siticasis",
    password: "123",
    status_pembayaran: "LUNAS",
    status_konversi: "CASIS Active",
...
export function getLocalDB() {
  ...
  return {
    ...
    materi: getOrInit("materi", defaultMateri),
    casis: getOrInit("casis", defaultCasis)
  };
}
...
export function saveLocalDB(db) {
  ...
  localStorage.setItem("sikad_materi", JSON.stringify(db.materi));
  localStorage.setItem("sikad_casis", JSON.stringify(db.casis || []));
}
