export const defaultUsers = [
  { id: "u1", email: "dosen1@triesakti.ac.id", password: "dosen", nama_lengkap: "Capt. Andi Wijaya, M.T.", nip: "NIP. 198504122010121001", role: "dosen", foto_profil: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=100", no_rekening: "1234567890", nama_bank: "BCA", nama_pemilik_rek: "ANDI WIJAYA" },
  { id: "u2", email: "dosen2@triesakti.ac.id", password: "dosen", nama_lengkap: "Dr. Rina Astuti, S.Si., M.Sc.", nip: "NIP. 199008232015042002", role: "dosen", foto_profil: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=100", no_rekening: "0987654321", nama_bank: "Mandiri", nama_pemilik_rek: "RINA ASTUTI" },
  { id: "u3", email: "dosen3@triesakti.ac.id", password: "dosen", nama_lengkap: "Herman Susilo, S.T., M.M.", nip: "NIP. 197811052005011003", role: "dosen", foto_profil: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=100", no_rekening: "1122334455", nama_bank: "BNI", nama_pemilik_rek: "HERMAN SUSILO" },
  { id: "admin@triesakti.ac.id", email: "admin@triesakti.ac.id", password: "admin", nama_lengkap: "Admin Akademik Triesakti", nip: "NIP. 199201012018011001", role: "admin", foto_profil: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=100" }
];
